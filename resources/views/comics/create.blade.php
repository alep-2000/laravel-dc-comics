                ...
                <div>
                    ...
                    <form action=" {{ route('comics.store') }} " method="POST">
                        ...
                        <div class="class-group">
                            ...
                            <input type="text" id="cover_image" name="cover_image" class="form-control" placeholder="Cover Image" value="{{ old('cover_image') }}">
                        </div>
                        <div class="class-group">
                        ...
                        <div class="class-group">
                            ...
                            <input type="text" id="sale_date" name="sale_date" class="form-control" placeholder="Sale Date" value="{{ old('sale_date') }}">
                        </div>
                        <div class="class-group">
